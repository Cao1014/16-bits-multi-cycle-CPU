module control_unit (
    ...
    // Instantiating instruction register module
    ir ir1 (
        .clk(clk),
        .rst(rst),
        .ins(ins),
    ...
    // Instantiating state transition module
    ...
    // Assigning offset and data addresses based on instruction register output
