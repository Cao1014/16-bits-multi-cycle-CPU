...
HD_PWD='E:/Vivado2017/Lab/11.14_7segment_display/11.13_all_files.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log structure.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source structure.tcl
